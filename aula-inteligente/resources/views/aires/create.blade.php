...
<div class="container my-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="fw-bold" style="color: #5D7B6F;">Crear Aire Acondicionado</h1>
    </div>
    ...
    <div class="card p-4 shadow-lg rounded-3">
        <form action="{{ route('aires.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="temperatura" name="temperatura" value="{{ old('temperatura') }}" required>
            </div>

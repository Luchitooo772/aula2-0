            ...
            <div class="col-md-6">
                <div class="card shadow-lg rounded-3">
                    <div class="card-header bg-white text-center border-0 pt-4">
                        <h3 class="fw-bold" style="color: #5D7B6F;">Iniciar Sesión</h3>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" required autofocus style="border-radius: 0.75rem; border-color: #BDD4B8;">
                            </div>
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" id="remember" name="remember" style="border-color: #BDD4B8;">
                        ...
                        <div class="text-center mt-3">
                            <a href="{{ route('register.form') }}" style="color: #A4C3A2;">¿No tienes cuenta? Regístrate</a>
                        </div>
                    </div>
                </div>
            </div>
